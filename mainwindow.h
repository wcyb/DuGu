...
private:
    ...
    QString getFileTypeForSave(QString pathToFile) const;
    ...
    QStringList getOptionWithArg(unsigned short optionNumber, QString argument, QString operationType, QString valueType) const;
...
private:
    ...
    const QStringList m_operationTypes =
    {
        tr("Write"),
        tr("Read"),
        tr("Verify")
    ...
    const QStringList m_memoryTypes =
    {
        tr("Flash"),
        tr("EEPROM"),
        tr("Other")
    ...
    const QStringList m_additionalOptionsArg =
    {
        "-b",
        "-B",
        "-C",
    ...
    const QStringList m_additionalOptionsDesc =
    {
        tr("Baudrate"),
        tr("Bitclock"),
        tr("Config file"),
    ...
    const QStringList m_additionalOptionsToolTip =
    {
        tr("Baudrate"),
        tr("Bitclock"),
    ...
    const QStringList m_itemLists[1][1] =
    {
        {
            QStringList
            {
    ...
    const additionalOptionsTypes m_additionalOptionsValues[25] =
    {
        ...
        additionalOptionsTypes::text,
        additionalOptionsTypes::filePath,
        additionalOptionsTypes::logic,
        additionalOptionsTypes::logic,
        additionalOptionsTypes::itemList,
        additionalOptionsTypes::logic,
        additionalOptionsTypes::text,
        additionalOptionsTypes::logic,
        additionalOptionsTypes::logic,
